class ClimbingCities::CLI
  ...
  def menu
    ...
    while input != "exit"
      puts " "
      puts "Would you like to learn more about the city?  \nIf yes, please type yes and hit enter.  \nIf you would like to see to the list of cites again, please type list.  \nOtherwise, type exit."
      puts " "
  ...
  # takes city choice and fetches city description
  def choose_city
    puts " "
